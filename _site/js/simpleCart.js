            ...
            simpleCart.extend({
                ...
                writeCart: function (selector) {
                    var TABLE = settings.cartStyle.toLowerCase(),
                        ...
                        x,
                        xlen;
                       $(".ck-btn,.basket-detail,.harga-total,#total-harga,.right_side,.lisQdaffadev,.chatWhatsapp,.cOut").hide();
                ...
                createCartRow: function (item, y, TR, TD, container) {
                    ...
                    $(".ck-btn,.basket-detail,.harga-total,#total-harga,.right_side,.lisQdaffadev,.cOut").show();
