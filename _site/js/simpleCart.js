        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                currency: function (item, column) {
                    return ["<span class='sub-total'></span> " + simpleCart.toCurrency(item.get(column.attr) || 0)];
                },
                jumlah: function (item, column) {
                    return ["<span class='jumlah'>" + item.get(column.attr) + "</span>"];
                },
                ...
                thumb: function (item, column) {
                    return ["<img class='img-fluid' src='" + item.get(column.attr) + "'/>"];
                },
                name: function (item, column) {
                    return "<span class='item_name'" + item.get(column.attr) + "'>" + column.text + "</span>";
                },
            ...
            simpleCart.extend({
                ...
                writeCart: function (selector) {
                    var TABLE = settings.cartStyle.toLowerCase(),
                        ...
                        x,
                        xlen;
                       $(".ck-btn,.basket-detail,.harga-total,#total-harga,.front-total").hide();
                       $(".keranjang-kosong").show();

                    container.html(" ").append(cart_container);

					cart_container.append(cart_empty);
                ...
                createCartRow: function (item, y, TR, TD, container) {
                    ...
                    $(".ck-btn,.basket-detail,.harga-total,#total-harga,.front-total").show();
